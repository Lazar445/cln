/**
 * Code by Nicko - yt.com/nickoscriptz
 * github.com/destroyednicko | t.me/spartey
 * 
 * Mirrored Cloner - 1.0
 */
...
async function run() {
    ...
    await logAscii()
    process.title = '@nickoscriptz | Mirrored Cloner [Config]'
    ...
    client.on('ready', async() => {
        ...
        guilds.forEach(g => {
            if (!g) {
                log('Unknown server, verify the ID!', 3)
                process.exit(1)
            }
        })
        ...
        process.title = `@nickoscriptz | Mirrored Cloner [Cloning ${guilds[0].name}]`;
        ...
        for (let role of itens.roles) {
            ...
            }).then(r => log(`Created role: ${r.name}`, 1))
        }
...
async function logAscii() {
    ...
    console.log(`
                ...
                888b     d888 d8b                                              888 
                8888b   d8888 Y8P       youtube.com/nickoscriptz               888 
                88888b.d88888                                                  888 
                888Y88888P888 888 888d888 888d888 .d88b.  888d888 .d88b.   .d88888 
                888 Y888P 888 888 888P"   888P"  d88""88b 888P"  d8P  Y8b d88" 888 
                888  Y8P  888 888 888     888    888  888 888    88888888 888  888 
                888   "   888 888 888     888    Y88..88P 888    Y8b.     Y88b 888 
                888       888 888 888     888     "Y88P"  888     "Y8888   "Y88888 
                        the ultimate discord cloner | open-source solution 
`.brightMagenta)
}
